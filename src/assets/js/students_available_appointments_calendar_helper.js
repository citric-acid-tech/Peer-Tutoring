...
//			$('#filter-my_appointments .curtain').fadeIn();
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.cancelAppointment = function (id) {
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.resetForm = function () {
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.display = function (appointment) {
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.filter = function (bs, st, tn, selectId, display, first_load) {
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.getFilterHtml = function (index, appointment) {
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.decodeBookingStatus = function (booking_status) {
     ...
     * on the form.
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.select = function (id, display) {
        display = display || false;
...
//                    $('#edit-appointment, #delete-appointment').prop('disabled', false);
     ...
     * Clear assessment
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.clearAssess = function() {
		$('#assess_feedback').val('');
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.getAllTutors = function() {
     ...
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.getAllServiceCategories = function() {
     ...
     * Get all service categories and wrap them in an html
     */
    StudentsAvailableAppointmentsCalendarHelper.prototype.filterList = function(filterItem, filterValue) {
