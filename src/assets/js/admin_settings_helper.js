(function () {
    ...
    /**
     * AdminSettingsHelper Class
     *
     * This class contains the methods that are used in the AdminSettingsHelper page.
     *
    ...
    /**
     * Binds the default event handlers of the AdminSettingsHelper page.
     */
    AdminSettingsHelper.prototype.bindEventHandlers = function () {
        var instance = this;
...
//			$('#filter-appointments_management .curtain').slideDown(360);
     ...
     */
    AdminSettingsHelper.prototype.resetForm = function () {
     ...
     */
    AdminSettingsHelper.prototype.display = function (appointment) {
     ...
     */
    AdminSettingsHelper.prototype.filter = function (id, bs, st, tn, sn, sd, ed, selectId, display, first_load) {
     ...
     */
    AdminSettingsHelper.prototype.getFilterHtml = function (index, appointment) {
     ...
     */
    AdminSettingsHelper.prototype.decodeBookingStatus = function (booking_status) {
     ...
     * on the form.
     */
    AdminSettingsHelper.prototype.select = function (id, display) {
        display = display || false;
...
//                    $('#edit-appointment, #delete-appointment').prop('disabled', false);
     ...
     */
    AdminSettingsHelper.prototype.getAllTutors = function() {
     ...
     */
    AdminSettingsHelper.prototype.getAllStudents = function() {
     ...
     */
    AdminSettingsHelper.prototype.getAllServiceCategories = function() {
     ...
     * Get all service categories and wrap them in an html
     */
    AdminSettingsHelper.prototype.filterList = function(filterItem, filterValue) {
     ...
     * Get all service categories and wrap them in an html
     */
    AdminSettingsHelper.prototype.validateDateTime = function(sd, ed) {
    ...
    window.AdminSettingsHelper = AdminSettingsHelper;
})();
