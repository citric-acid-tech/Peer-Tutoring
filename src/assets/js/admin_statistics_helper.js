...
//			$('#filter-appointments_management .curtain').slideDown(360);
     ...
     */
    AdminStatisticsHelper.prototype.resetForm = function () {
     ...
     */
    AdminStatisticsHelper.prototype.display = function (appointment) {
     ...
     */
    AdminStatisticsHelper.prototype.filter = function (id, bs, st, tn, sn, sd, ed, selectId, display, first_load) {
     ...
     */
    AdminStatisticsHelper.prototype.getFilterHtml = function (index, appointment) {
     ...
     * on the form.
     */
    AdminStatisticsHelper.prototype.select = function (id, display) {
        display = display || false;
...
//                    $('#edit-appointment, #delete-appointment').prop('disabled', false);
     ...
     */
    AdminStatisticsHelper.prototype.getAllTutors = function() {
     ...
     */
    AdminStatisticsHelper.prototype.getAllStudents = function() {
     ...
     */
    AdminStatisticsHelper.prototype.getAllServiceCategories = function() {
     ...
     * Get all service categories and wrap them in an html
     */
    AdminStatisticsHelper.prototype.filterList = function(filterItem, filterValue) {
