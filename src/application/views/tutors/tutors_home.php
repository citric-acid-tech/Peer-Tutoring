...
<div id="tutor-appointment-management-page" class="container-fluid tutors-page">
    <div class="row">
    		...
    		<form>
                <div class="input-group">
                   <div class="input-group-selection">
 						...
 						<!-- Select Student Name -->
                   		<input type="text" class="key form-control currently-not-needed" id="tutor-appointment_management_students" placeholder="<?= lang('type_for_a_student') ?>" title="<?= lang('type_for_a_student') ?>" autocomplete="off" />
                  		...
                  		<!-- Select Date -->
                  		<input type="text" class="form-control currently-not-needed" id="tutor-appointment_management_start_date" placeholder="<?= lang('select_a_minimum_starting_date') ?>" title="<?= lang('select_a_minimum_starting_date') ?>" autocomplete="off" readonly />
                  		<input type="text" class="form-control currently-not-needed" id="tutor-appointment_management_end_date" placeholder="<?= lang('select_a_maximum_ending_date') ?>" title="<?= lang('select_a_maximum_ending_date') ?>" autocomplete="off" readonly />
                   </div>
    	...
    	<div class="record-details col-xs-12 col-sm-6 col-md-7 col-lg-8 col-xl-10">
           ...
           <h3 style="margin-top:15px;"><?= lang('details') ?></h3>
           ...
           <div class="row" style="margin-top:5px;">
           	<div class="col-xs-12">
            	<div class="form-group">
            	    ...
            	    <textarea id="notes" class="form-control" style="resize:none;" rows="3" readonly></textarea>
            	</div>
           	</div>
           </div>
    	</div>
